...
:use_pwsh
pwsh.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%BUILD_PS%" -BuildGateway
set "ERR=%ERRORLEVEL%"
pause
exit /b %ERR%

:use_powershell
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%BUILD_PS%" -BuildGateway
set "ERR=%ERRORLEVEL%"
pause
exit /b %ERR%
